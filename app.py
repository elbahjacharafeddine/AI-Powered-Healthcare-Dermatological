...
app.config["MONGODB_SETTINGS"] = {
    "db": "Medical",
    "host": "mongodb://localhost/Medical",
    "retryWrites": False,
}
...
if connect:
    print("Database connection successful")  # Print a message indicating success
    new_user = User(
        username='elbahjacharafeddine',
        password=generate_password_hash("elbahja"),  # You should hash the password before saving it
        confirmPassword=generate_password_hash("elbahja"),  # Hashed confirmPassword
        nom='elbahja',
        prenom='charafeddine',
        photoName='john_doe.jpg',
        role=['user'],
        tel='1234567890',
        genre='Male'
    )
